...
//        String toLocation = to == 1? "A 기둥" : to == 2? "B 기둥" : "C 기둥";
    ...
    public void move3(int num, int from, int to) {
        Stack< Map <String, Integer >> stack = new Stack<>();
//
//        while (num > 0) {
//            stack.push(Map.of("num", num - 1, "from", from , "to", 6 - to -from));
//            stack.push(Map.of("num", num, "from", from, "to", to));
//            stack.push(Map.of("num", num - 1, "from", 6 - to -from , "to", to));
//        }
